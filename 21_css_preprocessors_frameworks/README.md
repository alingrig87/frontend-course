# CSS Preprocessors & Frameworks (Sass, Tailwind)

## Descriere
Această lecție explică **CSS Preprocessors & Frameworks (Sass, Tailwind)**. Scopul este să oferi o înțelegere practică și teoretică, exemple și exerciții pentru a putea aplica imediat conceptele în proiecte reale.

## Ce înveți
- Înțelegerea conceptelor cheie legate de: css preprocessors & frameworks (sass, tailwind)
...
- Explică pe scurt: CSS Preprocessors & Frameworks (Sass, Tailwind).
- Care sunt cele mai frecvente probleme întâlnite și cum le rezolvi?
- Demonstrează un exemplu practic în 5 pași.

## Mini-proiect (mic)
Proiect: Construiește un mic proiect care să exerseze conceptele descrise mai sus. De exemplu: Scrie un mic stylesheet în Sass și compilează-l; experimentează cu Tailwind..
