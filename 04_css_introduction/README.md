# Introducere în CSS (tipuri de legare, selectori)

## Descriere
Această lecție explică **Introducere în CSS (tipuri de legare, selectori)**. Scopul este să oferi o înțelegere practică și teoretică, exemple și exerciții pentru a putea aplica imediat conceptele în proiecte reale.

## Ce înveți
- Înțelegerea conceptelor cheie legate de: introducere în css (tipuri de legare, selectori)
...
- Explică pe scurt: Introducere în CSS (tipuri de legare, selectori).
- Care sunt cele mai frecvente probleme întâlnite și cum le rezolvi?
- Demonstrează un exemplu practic în 5 pași.

## Mini-proiect (mic)
Proiect: Construiește un mic proiect care să exerseze conceptele descrise mai sus. De exemplu: Aplică 3 tipuri de legare CSS (inline, internal, external) pe același HTML și observă diferențele..
